    ...
    <>
      ...
      >
        <Flex
          ...
          justifyContent="center"
          alignItems="center"
          cssClasses={["border-r-20", "service-tabs", "p-2", "border-gradient"]}
        >
          {SERVICES.map((service, index) => (
            <ServiceTab
              key={index}
      ...
      <Box cssClasses={["container"]}>
        ...
        >
          <p className="fw-700 font-size-lg-2 text-center mt-4">Why TikTok?</p>
          ...
          <Box cssClasses={["col-md-11", "m-auto", "mt-4", "pt-xxl-4", "pt-3"]}>
            <Flex direction={"row"} justifyContent="center">
              <Box cssClasses={["col-md-4", "pe-xxl-3", "pe-2"]}>
                <Image src={Service1} cssClasses={["service-gallery-pic"]} />
              </Box>
              <Box
                cssClasses={[
                  "col-md-8",
              ...
              >
                ...
                <Box cssClasses={["pt-xxl-3", "pt-2", "h-50", "gallery-panel"]}>
                  <Image src={Service4} cssClasses={["service-gallery-pic"]} />
                </Box>
              </Box>
            </Flex>
          </Box>
        ...
        >
          <Box cssClasses={["col-md-4"]}>
            ...
            <p className="font-size-md-4 opacity-color   mt-xxl-4 mt-3">
              ...
              <br />
              <br /> If you are going to use a passage of Lorem Ipsum, you need
